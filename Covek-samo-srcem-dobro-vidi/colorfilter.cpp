...
ColorFilter::ColorFilter(QString &fName, ColorFilter::Layer layer) : m_fName{fName}, m_layer{layer}
{
}
...
{
    std::unordered_map<QString, Layer> toLayer = {{"red", ColorFilter::Layer::RED},
